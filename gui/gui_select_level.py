...
class SelectLevel(Form):
    def __init__(self,name,master_surface,x,y,w,h,color_background,color_border,active):
        ...
        self.boton1 = Button(master=self,x=100,y=290,w=100,h=100,color_background=None,color_border=None,image_background="../Project2/recursos/gui/jungle/menu/play.png",on_click=self.cambiar_el_nivel,on_click_param="Nivel_1",text=None,font="Verdana",font_size=30,font_color=C_WHITE)
        self.boton2 = Button(master=self,x=300,y=290,w=100,h=100,color_background=None,color_border=None,image_background="../Project2/recursos/gui/jungle/menu/play.png",on_click=self.cambiar_el_nivel,on_click_param="Nivel_2",text=None,font="Verdana",font_size=30,font_color=C_WHITE)
        self.boton3 = Button(master=self,x=500,y=290,w=100,h=100,color_background=None,color_border=None,image_background="../Project2/recursos/gui/jungle/menu/play.png",on_click=self.cambiar_el_nivel,on_click_param="Nivel_3",text=None,font="Verdana",font_size=30,font_color=C_WHITE)
    ...
    def cambiar_el_nivel(self,parametro):        
        self.on_click_boton1(parametro)
        self.forms_dict["pause"].seguir_en_nivel(parametro)
