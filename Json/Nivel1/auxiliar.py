...
class Auxiliar:
    ...
    @staticmethod
    def getSurfaceFromSeparateFiles(path_format,quantity,flip=False, step = 1,scale=1,w=0,h=0):
        lista = []
    ...
    def lector_json(file):
        with open(file, 'r') as f:
            data = json.load(f)
        return data
    '''lista_a_cargar = cargar_json("C:/Users/rocio/Desktop/PP_STARWARS/data.json")
